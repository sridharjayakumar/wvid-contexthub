ContextHub.console.log(ContextHub.Shared.timestamp(), '[loading] contexthub.store.dnb-persisted-store - store.persisted-store.js');
...
//    };
    ...
    ContextHub.Utils.storeCandidates.registerStoreCandidate(TestStore, 'dnb-persisted-store', 0);
